...
while register()=="no":
    item=int(input("Please enter the index number of the item of want to purchase: "))  #as long as regiser says no, you will be asked to input another item from stock
if register()=="yes":
